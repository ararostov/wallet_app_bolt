...
const styles = StyleSheet.create({
  ...
  avatarText: { fontSize: 30, fontFamily: 'Inter-Bold', color: '#fff' },
  heroName: { fontSize: 24, fontFamily: 'Inter-Bold' },
  rewardBadge: { paddingHorizontal: 14, paddingVertical: 6, borderRadius: 20 },
  rewardBadgeText: { fontSize: 16, fontFamily: 'Inter-SemiBold' },
  ...
  sectionTitle: { fontSize: 17, fontFamily: 'Inter-Bold', marginBottom: 16 },
  ...
  timelineLabel: { fontSize: 16, fontFamily: 'Inter-Medium' },
  timelineDate: { fontSize: 15, fontFamily: 'Inter-Regular', marginTop: 2 },
  ...
  reminderBtnText: { fontSize: 17, fontFamily: 'Inter-SemiBold' },
});

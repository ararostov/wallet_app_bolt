...
const styles = StyleSheet.create({
  ...
  heroTitle: { fontSize: 28, fontFamily: 'Inter-Bold', letterSpacing: -0.5 },
  heroSub: { fontSize: 15, fontFamily: 'Inter-Regular', textAlign: 'center', lineHeight: 22 },
  ...
  codeLabel: { fontSize: 12, fontFamily: 'Inter-SemiBold', letterSpacing: 0.5 },
  ...
  codeText: { fontSize: 24, fontFamily: 'Inter-Bold', letterSpacing: 3 },
  shareBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, borderRadius: 12, paddingVertical: 14 },
  shareBtnText: { fontSize: 15, fontFamily: 'Inter-SemiBold', color: '#fff' },
  ...
  capText: { fontSize: 13, fontFamily: 'Inter-Regular' },
  ...
  friendAvatarText: { fontSize: 16, fontFamily: 'Inter-Bold', color: '#fff' },
  friendInfo: { flex: 1 },
  friendName: { fontSize: 15, fontFamily: 'Inter-SemiBold' },
  friendReward: { fontSize: 12, fontFamily: 'Inter-SemiBold', marginTop: 2 },
  stageChip: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 20 },
  stageChipText: { fontSize: 11, fontFamily: 'Inter-SemiBold' },
  ...
  stepTitle: { fontSize: 14, fontFamily: 'Inter-SemiBold' },
  stepDesc: { fontSize: 13, fontFamily: 'Inter-Regular', lineHeight: 18 },
});

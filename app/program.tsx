...
const styles = StyleSheet.create({
  ...
  perkIconText: { fontSize: 22 },
  perkInfo: { flex: 1 },
  perkTitle: { fontSize: 15, fontFamily: 'Inter-SemiBold' },
  perkShortRule: { fontSize: 12, fontFamily: 'Inter-Regular', marginTop: 2 },
  ...
  progressLabel: { fontSize: 12, fontFamily: 'Inter-Regular' },
  progressTrack: { height: 6, borderRadius: 3, overflow: 'hidden' },
  progressFill: { height: 6, borderRadius: 3 },
  expandContent: { paddingHorizontal: 14, paddingBottom: 14, borderTopWidth: 1, paddingTop: 12, gap: 8 },
  expandFullRules: { fontSize: 13, fontFamily: 'Inter-Regular', lineHeight: 20 },
  infoRow: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 6, borderTopWidth: 1 },
  infoLabel: { fontSize: 13, fontFamily: 'Inter-Regular' },
  infoValue: { fontSize: 13, fontFamily: 'Inter-SemiBold' },

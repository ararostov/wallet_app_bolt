...
const styles = StyleSheet.create({
  ...
  docUpdated: { fontSize: 12, fontFamily: 'Inter-Regular', marginTop: 2 },
  modalSafe: { flex: 1 },
  ...
  modalUpdated: { fontSize: 12, fontFamily: 'Inter-Regular', marginTop: 2 },
  modalContent: { padding: 16, paddingBottom: 40 },
  docContent: { fontSize: 15, fontFamily: 'Inter-Regular', lineHeight: 24 },
  modalFooter: { padding: 16, borderTopWidth: 1 },
  downloadBtn: { borderWidth: 1.5, borderRadius: 12, paddingVertical: 12, alignItems: 'center' },
  downloadBtnText: { fontSize: 14, fontFamily: 'Inter-SemiBold' },
});

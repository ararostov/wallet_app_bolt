...
const styles = StyleSheet.create({
  ...
  faqQuestionText: { flex: 1, fontSize: 14, fontFamily: 'Inter-SemiBold', lineHeight: 20 },
  faqAnswer: { fontSize: 14, fontFamily: 'Inter-Regular', lineHeight: 22, paddingHorizontal: 14, paddingBottom: 14 },
  ...
  contactTitle: { fontSize: 17, fontFamily: 'Inter-Bold' },
  contactSub: { fontSize: 14, fontFamily: 'Inter-Regular' },
  contactBtn: { borderRadius: 10, paddingHorizontal: 16, paddingVertical: 10, marginTop: 4 },
  contactBtnText: { fontSize: 14, fontFamily: 'Inter-SemiBold' },
});

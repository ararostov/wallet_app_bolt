...
const styles = StyleSheet.create({
  ...
  enableTitle: { fontSize: 16, fontFamily: 'Inter-SemiBold' },
  enableSub: { fontSize: 13, fontFamily: 'Inter-Regular', marginTop: 2 },
  ...
  configTitle: { fontSize: 14, fontFamily: 'Inter-Medium' },
  ...
  stepperValue: { fontSize: 28, fontFamily: 'Inter-Bold', minWidth: 80, textAlign: 'center' },
  stepperRange: { fontSize: 12, fontFamily: 'Inter-Regular' },
  sourceCard: { borderRadius: 12, padding: 14, marginBottom: 12, flexDirection: 'row', justifyContent: 'space-between', borderWidth: 1 },
  sourceLabel: { fontSize: 14, fontFamily: 'Inter-Regular' },
  sourceValue: { fontSize: 14, fontFamily: 'Inter-SemiBold' },
  bonusCard: { flexDirection: 'row', alignItems: 'center', gap: 8, borderRadius: 10, padding: 12, marginBottom: 20, borderWidth: 1 },
  bonusText: { fontSize: 14, fontFamily: 'Inter-SemiBold' },

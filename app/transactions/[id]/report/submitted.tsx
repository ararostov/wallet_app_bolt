...
const styles = StyleSheet.create({
  ...
  refValue: { fontSize: 20, fontFamily: 'Inter-Bold', letterSpacing: 1 },
  ...
  timelineDay: { fontSize: 15, fontFamily: 'Inter-Bold' },
  timelineLabel: { fontSize: 15, fontFamily: 'Inter-Regular', marginTop: 1 },

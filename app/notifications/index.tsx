...
const styles = StyleSheet.create({
  ...
  markAllText: { fontSize: 13, fontFamily: 'Inter-SemiBold' },
  ...
  notifTitle: { fontSize: 14, fontFamily: 'Inter-Medium', flex: 1 },
  unreadDot: { width: 8, height: 8, borderRadius: 4 },
  notifPreview: { fontSize: 13, fontFamily: 'Inter-Regular', lineHeight: 18 },

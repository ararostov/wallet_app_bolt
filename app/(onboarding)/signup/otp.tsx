...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: 15, fontFamily: 'Inter-Regular', lineHeight: 22, marginBottom: 36 },
  ...
  countdown: { fontSize: 14, fontFamily: 'Inter-Regular' },
  countdownBold: { fontFamily: 'Inter-SemiBold' },
  resendLink: { fontSize: 14, fontFamily: 'Inter-SemiBold' },
  primaryBtn: {
    borderRadius: 14,
    paddingVertical: 16,
    alignItems: 'center',
  ...
  wrongNumber: { textAlign: 'center', fontSize: 14, fontFamily: 'Inter-Medium' },
});

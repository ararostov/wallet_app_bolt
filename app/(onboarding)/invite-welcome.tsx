...
const styles = StyleSheet.create({
  ...
  heroTitle: { fontSize: 26, fontFamily: 'Inter-Bold', color: '#fff', textAlign: 'center' },
  heroSubtitle: { fontSize: 15, fontFamily: 'Inter-Regular', color: 'rgba(255,255,255,0.85)', textAlign: 'center' },
  card: {
    borderRadius: 20,
    padding: 24,
  ...
  cardTitle: { fontSize: 17, fontFamily: 'Inter-Bold' },
  bonusRow: { flexDirection: 'row', alignItems: 'center' },
  bonusItem: { flex: 1, alignItems: 'center', gap: 4 },
  bonusDivider: { width: 1, height: 40 },
  bonusAmount: { fontSize: 28, fontFamily: 'Inter-Bold' },
  bonusLabel: { fontSize: 12, fontFamily: 'Inter-Regular' },
  bonusDesc: { fontSize: 14, fontFamily: 'Inter-Regular', lineHeight: 20, padding: 12, borderRadius: 10 },
  primaryBtn: {
    borderRadius: 14,
    paddingVertical: 16,
    alignItems: 'center',

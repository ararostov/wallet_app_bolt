...
const styles = StyleSheet.create({
  ...
  pmInfo: { flex: 1 },
  pmLabel: { fontSize: 17, fontFamily: 'Inter-SemiBold' },
  pmSub: { fontSize: 15, fontFamily: 'Inter-Regular', marginTop: 2 },
  actions: { flexDirection: 'row', alignItems: 'center', gap: 12 },
  defaultBadge: { flexDirection: 'row', alignItems: 'center', gap: 4, paddingHorizontal: 8, paddingVertical: 3, borderRadius: 20 },
  defaultText: { fontSize: 15, fontFamily: 'Inter-SemiBold' },
  setDefaultText: { fontSize: 15, fontFamily: 'Inter-SemiBold' },
  ...
  addText: { fontSize: 17, fontFamily: 'Inter-SemiBold' },
});

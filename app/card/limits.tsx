...
const styles = StyleSheet.create({
  ...
  limitValues: {},
  limitUsed: { fontSize: 16, fontFamily: 'Inter-Bold' },
  limitSep: { fontSize: 16 },
  limitCap: { fontSize: 16, fontFamily: 'Inter-Regular' },
  progressTrack: { height: 6, borderRadius: 3, overflow: 'hidden' },
  progressFill: { height: 6, borderRadius: 3 },
  progressFillWarning: { backgroundColor: '#f59e0b' },
  limitRemaining: { fontSize: 15, fontFamily: 'Inter-Regular' },
  perTxRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 14 },
  perTxValue: { fontSize: 16, fontFamily: 'Inter-SemiBold' },
  note: { fontSize: 15, fontFamily: 'Inter-Regular', textAlign: 'center', lineHeight: 18 },
});

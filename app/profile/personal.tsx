...
const styles = StyleSheet.create({
  ...
  input: { borderWidth: 1.5, borderRadius: 12, paddingHorizontal: 16, paddingVertical: 14, fontSize: 15, fontFamily: 'Inter-Regular' },
  ...
  lockedValue: { fontSize: 15, fontFamily: 'Inter-Regular' },
  hint: { fontSize: 12, fontFamily: 'Inter-Regular', marginTop: 4 },
  divider: { height: 1, marginVertical: 20 },
  sectionTitle: { fontSize: 16, fontFamily: 'Inter-SemiBold', marginBottom: 14 },
  contactRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 },
  contactValue: { fontSize: 15, fontFamily: 'Inter-Medium', marginTop: 2 },
  changeLink: { fontSize: 14, fontFamily: 'Inter-SemiBold' },

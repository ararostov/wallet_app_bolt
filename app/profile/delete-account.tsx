...
const styles = StyleSheet.create({
  ...
  warningText: { fontSize: 14, fontFamily: 'Inter-SemiBold' },
  sectionTitle: { fontSize: 15, fontFamily: 'Inter-Bold', marginBottom: 10 },
  ...
  checkLabel: { fontSize: 14, fontFamily: 'Inter-SemiBold' },
  checkDesc: { fontSize: 12, fontFamily: 'Inter-Regular', marginTop: 2, lineHeight: 16 },
  ...
  reasonText: { fontSize: 14, fontFamily: 'Inter-Medium', flex: 1 },
  ...
  step2Title: { fontSize: 22, fontFamily: 'Inter-Bold', marginBottom: 8 },
  step2Sub: { fontSize: 15, fontFamily: 'Inter-Regular', lineHeight: 22, marginBottom: 24 },
  boldRed: { fontFamily: 'Inter-Bold' },
  field: { marginBottom: 16 },
  label: { fontSize: 13, fontFamily: 'Inter-SemiBold', marginBottom: 6 },
  input: { borderWidth: 1.5, borderRadius: 12, paddingHorizontal: 16, paddingVertical: 14, fontSize: 15, fontFamily: 'Inter-SemiBold', letterSpacing: 3 },
  inputRow: { flexDirection: 'row', alignItems: 'center', borderWidth: 1.5, borderRadius: 12 },
  input2: { flex: 1, paddingHorizontal: 16, paddingVertical: 14, fontSize: 15, fontFamily: 'Inter-Regular' },

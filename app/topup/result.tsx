...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 26, fontFamily: 'Inter-Bold', textAlign: 'center', letterSpacing: -0.5 },
  subtitle: { fontSize: 15, fontFamily: 'Inter-Regular', textAlign: 'center', lineHeight: 22, marginBottom: 8 },
  receiptCard: {
    width: '100%',
    borderRadius: 16,
    padding: 4,
  ...
  receiptLabel: { fontSize: 14, fontFamily: 'Inter-Regular' },
  receiptValue: { fontSize: 14, fontFamily: 'Inter-Medium' },
